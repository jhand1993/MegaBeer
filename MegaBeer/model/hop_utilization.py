...
class TinsethModel(object):
    """ Class containing methods for AA isomizeration rates using Tinseth 1995 
        PhD model.  Temperature is fixed at 100 C (212 F).  This model separates 
        utilization rate function into two components f(t, SG) = g(t) x h(SG).
    """
    ...
    def utilization(t, G, max_u=4.15, r=0.04):
        ...
        Returns:
            float or numpy.ndarray: Gravity component of utilization fraction.
        """
        return TinsethModel.time_component(t, max_u, r) * TinsethModel.G_component(G)
    ...
    def utilization_grid(t_arr, G_arr, max_u=4.15, r=0.04):
        ...
        return TinsethModel.utilization(t_grid, G_grid, max_u=max_u, r=r)
